...
DEG = f"{WORKDIR}/DEG"
META = f"{WORKDIR}/Metadata"
TARGET = f"{WORKDIR}/LASSO_INFO/healthy_cohort_train_prev_median_filter/corr_0.35_above_pval_0.05_below"
...
# df_deg_phase_target.to_csv(f"{dir_table}/Table_S5.txt", sep="\t", index=False)
...
plt.tight_layout()
plt.savefig(f"{WORKDIR}/Figures/Supplementary_Figure_8.tiff", dpi=300, bbox_inches="tight")
plt.savefig(f"{WORKDIR}/Figures/Supplementary_Figure_8.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
# %%
