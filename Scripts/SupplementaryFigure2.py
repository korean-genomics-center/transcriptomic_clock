...
# %%
WORKDIR = ".."
train_corr = f"{WORKDIR}/Correlation/healthy_cohort_train_prev_median_filter/corr_0.0_above_pval_1.0_below/linear_regression_expression_Sample_Age_train.tsv"
valid_corr = f"{WORKDIR}/Correlation/healthy_cohort_valid_prev/corr_0.0_above_pval_1.0_below/linear_regression_expression_Sample_Age_valid.tsv"
test_corr = f"{WORKDIR}/Correlation/healthy_cohort2/corr_0.0_above_pval_1.0_below/linear_regression_expression_Sample_Age_test.tsv"
...
path_selected_features = f"{WORKDIR}/LASSO_INFO/healthy_cohort_train_prev_median_filter/corr_0.35_above_pval_0.05_below/regression_results.txt"
...
plt.tight_layout()
plt.savefig(f"{WORKDIR}/Figures/Supplementary_Figure_2.tiff", dpi=300, bbox_inches="tight")
plt.savefig(f"{WORKDIR}/Figures/Supplementary_Figure_2.png", dpi=300, bbox_inches="tight")
plt.show()
plt.close()
# %%
