...
dict_clocks = {"KoreanBloodClock": "Korean Blood Clock (This Study)", "RenClockGTExAge": "Ren's Clock (2020)", "PeterClock": "Peter's Clock (2015)"}
...
plt.savefig(f"{WORKDIR}/Figures/Supplementary_Figure_4.png", dpi=300)
plt.savefig(f"{WORKDIR}/Figures/Supplementary_Figure_4.tiff", dpi=300)
plt.show()
plt.close()
# %%
