...
if __name__ == "__main__":
    ...
    parser.add_argument("--infeat", type=str, default="./FeatureTable/healthy_illumina.txt")
    parser.add_argument("--outdir", type=str, default="./LinearRegression/standardized/healthy_illumina")
    parser.add_argument("--outfilename", type=str, default="test")
    parser.add_argument("--col_y", type=str, default="Sample_Age")
    parser.add_argument("--intermediatefilename", type=str, default="linear_regression_model_intermediate.pk.gz")
